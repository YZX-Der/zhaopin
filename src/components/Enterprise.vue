  ...
  <div>
    <div class="tabbar">
      <el-menu class="el-menu-demo" mode="horizontal">
        <el-menu-item index="1" @click="enterpriseGetClick">简历信息</el-menu-item>
        <el-menu-item index="2" @click="enterpriseSubmitClick">提交信息</el-menu-item>
        <el-menu-item index="3" @click="enterpriseChatClick">聊天信息</el-menu-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      enterpriseGetClick(){
        this.$router.replace({path:'enterpriseGetResume',query:{username:this.username}})
      },
      enterpriseSubmitClick(){
        this.$router.replace({path:'enterpriseSubmitRecruit',query:{username:this.username}})
      },
      enterpriseChatClick(){
        this.$router.replace({path:'enterpriseChat',query:{username:this.username}})
      },
      changePassword(){
